...
let options = {
  cities: ["Jeddah", "Cairo", "Bosaso", "Lascnood", "Makkah", "Dubai"],
  teams: ["RealMadrid", "Arsenal", "Leakers", "Barca", "Bayern", "ManUnited"],
  countries: ["Somalia", "Egypt", "Saudi", "Canada", "UAE", "Pakistan"],
}
let winCount = 0
let count = 0
let chosenWord = ""
